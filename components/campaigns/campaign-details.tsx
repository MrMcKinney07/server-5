...
export function CampaignDetails({ campaign }: CampaignDetailsProps) {
  ...
  const [quietHoursStart, setQuietHoursStart] = useState(campaign.quiet_hours_start?.slice(0, 5) || "20:00")
  const [quietHoursEnd, setQuietHoursEnd] = useState(campaign.quiet_hours_end?.slice(0, 5) || "08:00")
